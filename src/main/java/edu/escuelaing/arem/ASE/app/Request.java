 ...
 * 
 * Encapsula toda la información de una petición HTTP incluyendo:
 * - URI y parámetros de query
 * - Cuerpo de la petición (body)
 * - Headers HTTP
 * - Métodos de utilidad para parsing de datos
 */
public class Request {
    ...
    public Map<String, String> getQueryParams() {
        ...
        if (uri.getQuery() == null) return params;
    ...
    /**
     * Parsea el cuerpo como datos de formulario (application/x-www-form-urlencoded).
     * @return Mapa con los datos del formulario
     */
    public Map<String, String> getFormData() {
        Map<String, String> formData = new HashMap<>();
        if (!hasBody()) return formData;
     ...
     * Nota: Este es un parser muy básico, para casos complejos usar una librería JSON.
    ...
    public String toString() {
     ...
     /**
     * Builder para crear respuestas HTTP.
     * Métodos: withStatus, withContentType, withBody, withBodyBytes, addHeader, build.
     */
